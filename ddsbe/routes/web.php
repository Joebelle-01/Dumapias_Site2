...
$router->get('/debug', function () use ($router) {
    return [
        ...
        'userjob_model_exists' => class_exists('App\Models\UserJob'),
        'userjob_controller_exists' => class_exists('App\Http\Controllers\UserJobController'),
    ];
});

// Job routes (ADD THESE LINES)
